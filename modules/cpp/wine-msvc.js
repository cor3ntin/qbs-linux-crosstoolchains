...
function makeCommand(bin, args) {
    var underlying = FileInfo.realPath(bin);
    if(underlying.endsWith(".sh")) {
        args.unshift(bin);
        bin = "bash"
    }
...
function prepareCompiler(project, product, inputs, outputs, input, output, explicitlyDependsOn) {
    ...
    var cmd = makeCommand(compilerPath, args)
...
function prepareLinker(project, product, inputs, outputs, input, output) {
    ...
    var linkerOutputNativeFilePath = primaryOutput.filePath;
    ...
    var compilerLibraryPaths = input.cpp.compilerLibraryPaths;
    if (compilerLibraryPaths)
        libraryPaths = libraryPaths.uniqueConcat(compilerLibraryPaths);
    ...
    var commands = [];
    var cmd = makeCommand(linkerPath, args)
