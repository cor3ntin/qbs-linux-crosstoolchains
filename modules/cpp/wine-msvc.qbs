...
CppModule {
    ...
    Rule {
        ...
        prepare: {
            ...
            var cmd = MSVC.makeCommand("lib.exe", args);
    ...
    Rule {
        ...
        prepare: {
            var rcPath = FileInfo.joinPaths(toolchainInstallPath, "rc.exe")
            ...
            var cmd = MSVC.makeCommand(rcPath, args);
    ...
    Rule {
        ...
        prepare: {
            ...
            var cmd = MSVC.makeCommand(product.cpp.assemblerPath, args);
